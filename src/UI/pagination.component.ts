...
export class XPaginationComponent extends HTMLElement {
    ...
    constructor() {
        ...
        this._shadowRoot.appendChild(paginationComponentTemplate.content.cloneNode(true));
        this._container = this.shadowRoot.querySelector("#pagination");
    ...
    private changePage(page) {
        ...
        setTimeout(() => {
            const activePage = this._shadowRoot.querySelector(`.pagination li[data-page="${this._page}"]`);
            if (activePage) {
    ...
    <a href="#" aria-label="Next">
      <span aria-hidden="true">&raquo;</span>
        ...
        this._shadowRoot.querySelector('.pagination').innerHTML = pagesHTML;
